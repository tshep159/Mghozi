...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers( "/request","/registration","/error", "/post/**", "/h2-console/**").permitAll()
                .antMatchers("/","/user/reset-password-change","/user/activation-send","/user/reset-password","/faq","/about","/reset-password","/password","/privacy","/add/suggestion","/add/place").permitAll()
                .antMatchers("/newPost/**", "/commentPost/**", "/createComment/**").hasAnyRole("USER")
                .antMatchers("/municipality/**").hasAnyRole("MUNICIPALITY")
                .antMatchers("/employee/**").hasAnyRole("TECH")
     ...
     * @param web
     * @throws Exception
     * Allowing Spring security to scan static folder
     */
    @Override
